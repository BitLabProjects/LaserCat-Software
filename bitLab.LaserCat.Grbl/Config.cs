...
namespace bitLab.LaserCat.Grbl
{
  public partial class GrblFirmware
  {
    ...
    //public int CPU_MAP_ATMEGA328P_TRADITIONAL = // Arduino Uno CPU
    ...
    //public int HOMING_INIT_LOCK = // Comment to disable
    public bool HOMING_INIT_LOCK = true;
    ...
    // greater.
    public byte N_HOMING_LOCATE_CYCLE = 2 // Integer (1-128)
    ;
    ...
    public int N_STARTUP_LINE = 2 // Integer (1-2)
    ;
    ...
    public int N_DECIMAL_COORDVALUE_INCH = 4; // Coordinate or position value in inches
    public int N_DECIMAL_COORDVALUE_MM = 3; // Coordinate or position value in mm
    public int N_DECIMAL_RATEVALUE_INCH = 1; // Rate or velocity value in in/min
    public int N_DECIMAL_RATEVALUE_MM = 0; // Rate or velocity value in mm/min
    public int N_DECIMAL_SETTINGVALUE = 3; // Decimals for floating point setting values
    ...
    //public int MESSAGE_PROBE_COORDINATES = // Enabled by default. Comment to disable.
    ...
    public const bool ADAPTIVE_MULTI_AXIS_STEP_SMOOTHING = false; // Default enabled. Comment to disable.
    ...
    public float SPINDLE_MAX_RPM = 1000.0f;// Max spindle RPM. This value is equal to 100% duty cycle on the PWM.
    public float SPINDLE_MIN_RPM = 0.0f;// Min spindle RPM. This value is equal to (1/256) duty cycle on the PWM.
    ...
    public float MINIMUM_JUNCTION_SPEED = 0.0f; // (mm/min)
    ...
    public float MINIMUM_FEED_RATE = 1.0f; // (mm/min)

    // Number of arc generation iterations by small angle approximation before exact arc trajectory 
    // correction with expensive sin() and cos() calcualtions. This parameter maybe decreased if there 
    // are issues with the accuracy of the arc generations, or increased if arc execution is getting
    // bogged down by too many trig calculations. 
    public int N_ARC_CORRECTION = 12; // Integer (1-255)
    ...
    public int DWELL_TIME_STEP = 50; // Integer (1-255) (milliseconds)
