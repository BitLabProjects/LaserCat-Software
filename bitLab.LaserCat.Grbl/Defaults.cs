...
namespace bitLab.LaserCat.Grbl
{
  public partial class Grbl
  {
    ...
    public const float DEFAULT_X_ACCELERATION = (10.0f * 60 * 60); // 10*60*60 mm/min^2 = 10 mm/sec^2
    public const float DEFAULT_Y_ACCELERATION = (10.0f * 60 * 60); // 10*60*60 mm/min^2 = 10 mm/sec^2
    public const float DEFAULT_Z_ACCELERATION = (10.0f * 60 * 60); // 10*60*60 mm/min^2 = 10 mm/sec^2
    public const float DEFAULT_X_MAX_TRAVEL = 200.0f; // mm
    public const float DEFAULT_Y_MAX_TRAVEL = 200.0f; // mm
    ...
    public const bool DEFAULT_AUTO_START = true; // true
    public const bool DEFAULT_INVERT_ST_ENABLE = false; // false
    public const bool DEFAULT_INVERT_LIMIT_PINS = false; // false
    public const bool DEFAULT_SOFT_LIMIT_ENABLE = false; // false
    public const bool DEFAULT_HARD_LIMIT_ENABLE = false;  // false
    public const bool DEFAULT_HOMING_ENABLE = false;  // false
    public const byte DEFAULT_HOMING_DIR_MASK = 0; // move positive dir
    public const float DEFAULT_HOMING_FEED_RATE = 25.0f; // mm/min
    public const float DEFAULT_HOMING_SEEK_RATE = 500.0f; // mm/min
    public const ushort DEFAULT_HOMING_DEBOUNCE_DELAY = 250; // msec (0-65k)
    public const float DEFAULT_HOMING_PULLOFF = 1.0f; // mm
    //#endif
